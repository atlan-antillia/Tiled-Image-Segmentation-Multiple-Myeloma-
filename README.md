...
Furthermore, we have updated <b>create</b> method <a href="./TensorflowUNet.py">TensorflowUNet</a> class
to insert BatchNormalization layers when that <b>normalization</b> flag is True.<br>
